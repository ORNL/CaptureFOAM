...
Foam::autoPtr<Foam::enhancementModel> Foam::enhancementModel::New
(
...
)
{
    ...
    word modelType = dict.lookupOrDefault<word>("enhancementModel", "none");

    Info<< "Selecting enhancement model " << modelType << endl;
    ...
    if (cstrIter == dictionaryConstructorTablePtr_->end())
    {
        FatalErrorInFunction
            << "Unknown " << enhancementModel::typeName<< " type "
            << modelType << nl << nl
            << "Valid  enhancementModels are : " << endl
